...
public class PersonControllerTest {
	...
	public void testGetPersonById() throws Exception {
		...
		ResponseEntity<Person> response3 = template.getForEntity("/api/person/" + id, Person.class);
	...
	public void testGetPersonByNull() throws Exception {
		ResponseEntity<Person> response3 = template.getForEntity("/api/person/1", Person.class);
